...
const APIGASTO = 'http://3.133.175.35/pruebas/otro_gastos.php'
...
const GastosdelDia = () => {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (formData) => {
            ...
            console.log(rest);
            if (rest.data === "Exito") {
                alert("Se Ingreso con Exito el Gasto") 
                CajaGeneral()
                handleClose()
            }
        }
    ...
    return (
        ...
        <>
            <h1 className="text-2xl text-center text-bolg p-2"><i>Otros Gastos anexos</i></h1>
            <hr />
